...
<div>
  ...
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <nuxt-link to="/about-creator" class="nav-link">
    ...
    <nuxt-link to="/write-for-us" class="nav-link">
